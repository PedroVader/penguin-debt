      ...
      <div className="section-container">
        ...
        <div className="mt-16 bg-text-primary rounded-lg p-8 text-center text-white">
          ...
          <p className="mb-6 text-gray-300">
            Join thousands of Americans on their journey to financial freedom
          </p>
          <form className="max-w-md mx-auto flex gap-4">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-white text-text-primary font-semibold rounded-lg hover:bg-gray-100 transition-colors"
            >
              Subscribe
            </button>
          </form>
